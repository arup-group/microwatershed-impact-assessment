    ...
    with st.spinner("Fetching DEM from 3DEP..."):
        try:
            with tempfile.TemporaryDirectory() as tmp_dir:
                ...
                annual_rainfall_path = r'data-inputs\\Annual-Rainfall\\PRISM_ppt_30yr_normal_4kmM4_annual_bil.bil'
                ...
                with rasterio.open(annual_rainfall_path) as src:
                    ...
                    with rasterio.open("streamorder\\colorado_sample_dem.tiff") as dst:
                        ...
                        with rasterio.open(
                            "data-inputs\\temp\\temp_reprojected_raster_rainfall.tif",
                            "w",
                            driver="GTiff",
                            width=width,
                            height=height,
                ...
                annual_rainfall_path = 'data-inputs\\temp\\temp_reprojected_raster_rainfall.tif'
                ...
                raster_path = 'data-inputs\\temp\\temp_reprojected_raster_rainfall.tif'
